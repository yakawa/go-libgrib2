...
// Template4_2 : Derived forecast based on all ensemble members at a horizontal level or in a horizontal layer at a point in time
type Template4_2 struct {
	ParameterCategory               common.Grib2CodeValue      // Parameter category (see Code Table 4.1)
	ParameterNumber                 common.Grib2CodeValue      // Parameter number (see Code Table 4.2)
	TypeOfGeneratingProcess         common.Grib2CodeValue      // Type of generating process (see Code Table 4.3)
	BackgroundProcess               common.Grib2NumericalValue // Background generating process identifier (defined by originating Centre)
	...
	ScaleFactorOfSecondFixedSurface common.Grib2NumericalValue // Scale factor of second fixed surface
	ScaledValueOfSecondFixedSurface common.Grib2NumericalValue // Scaled value of second fixed surface
	DerivedForecast                 common.Grib2CodeValue      // Derived forecast (see Code Table 4.7)
	NumberOfForecastsInEnsemble     common.Grib2NumericalValue // Number of forecasts in ensemble
}

//
func ReadTemplate4_2(data []byte) Template4_2 {
	var o10, o11, o12, o13, o14 uint8
	var o15 uint16
	var o17 uint8
	var o18 uint8
	...
	return Template4_2{
		...
		ScaleFactorOfSecondFixedSurface: common.ReadSignedNumericalValue(o30),
		ScaledValueOfSecondFixedSurface: common.ReadUnsignedNumericalValue(o31),
		DerivedForecast:                 common.ReadCodeValue(o35),
		NumberOfForecastsInEnsemble:     common.ReadUnsignedNumericalValue(o36),
	}
}
...
// Template4_12 : Derived forecasts based on all ensemble members at a horizontal level or in a horizontal layer in a continuous or non-continuous time interval
type Template4_12 struct {
	ParameterCategory                   common.Grib2CodeValue      // Parameter category (see Code table 4.1)
	ParameterNumber                     common.Grib2CodeValue      // Parameter number (see Code table 4.2)
	TypeOfGeneratingProcess             common.Grib2CodeValue      // Type of generating process (see Code table 4.3)
	BackgroundProcess                   common.Grib2NumericalValue // Background generating process identifier (defined by originating centre)
...
// ReadTemplate4_12 : Read Template 4.12
func ReadTemplate4_12(data []byte) Template4_12 {
	var o10, o11, o12, o13, o14 uint8
	var o15 uint16
	var o17 uint8
	var o18 uint8
	...
	_ = binary.Read(bytes.NewBuffer(data[25:]), binary.BigEndian, &o35)
	_ = binary.Read(bytes.NewBuffer(data[26:]), binary.BigEndian, &o36)
	_ = binary.Read(bytes.NewBuffer(data[27:]), binary.BigEndian, &year)
	_ = binary.Read(bytes.NewBuffer(data[29:]), binary.BigEndian, &month)
	_ = binary.Read(bytes.NewBuffer(data[30:]), binary.BigEndian, &day)
	_ = binary.Read(bytes.NewBuffer(data[31:]), binary.BigEndian, &hour)
	_ = binary.Read(bytes.NewBuffer(data[32:]), binary.BigEndian, &seconds)
	_ = binary.Read(bytes.NewBuffer(data[33:]), binary.BigEndian, &minutes)
	_ = binary.Read(bytes.NewBuffer(data[34:]), binary.BigEndian, &o44)
	_ = binary.Read(bytes.NewBuffer(data[35:]), binary.BigEndian, &o45)
	_ = binary.Read(bytes.NewBuffer(data[39:]), binary.BigEndian, &o49)
	_ = binary.Read(bytes.NewBuffer(data[40:]), binary.BigEndian, &o50)
	_ = binary.Read(bytes.NewBuffer(data[41:]), binary.BigEndian, &o51)
	_ = binary.Read(bytes.NewBuffer(data[42:]), binary.BigEndian, &o52)
	_ = binary.Read(bytes.NewBuffer(data[46:]), binary.BigEndian, &o56)
	_ = binary.Read(bytes.NewBuffer(data[47:]), binary.BigEndian, &o57)
	...
	return Template4_12{
		...
		NumberOfForecastsInEnsemble:         common.ReadUnsignedNumericalValue(o36),
		EndOfOverallTimeInterval:            time.Date(int(year), time.Month(int(month)), int(day), int(hour), int(minutes), int(seconds), 0, loc),
		NumberOfTimeRange:                   common.ReadUnsignedNumericalValue(o44),
		NumberOfMissingInStatisticalProcess: common.ReadUnsignedNumericalValue(o45),
		TypeOfStatisticalProcessing:         common.ReadCodeValue(o49),
		TypeOfTimeIncrement:                 common.ReadCodeValue(o50),
		IndicatorOfUnitForTimeRange:         common.ReadCodeValue(o51),
		LengthOfTimeRange:                   common.ReadUnsignedNumericalValue(o52),
		IndicatorOfUnitForTimeIncrement:     common.ReadCodeValue(o56),
		TimeIncrement:                       common.ReadUnsignedNumericalValue(o57),
	}
